...
final public class Loaf {
    ...
    public struct Style {
        ...
        public init(
            ...
            font: UIFont = UIFont(name: "Heebo-Regular", size: 14) ?? .systemFont(ofSize: 14, weight: .medium),// systemFont(ofSize: 14, weight: .medium),
...
final class LoafViewController: UIViewController {
    ...
    var font = UIFont.systemFont(ofSize: 14, weight: .medium)// systemFont(ofSize: 14, weight: .medium)
